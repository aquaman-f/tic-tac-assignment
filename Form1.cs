...
namespace tic_tac_toe_1
{
    public partial class Form1 : Form
    {
        ...
        {
            //add actions to alla buttons inside panel2
        ...
        {
            int allButtonsLength = 0;
            foreach (Control c in panel2.Controls)
            {
                if (c is Button)
                {
                    allButtonsLength += c.Text.Length;
                }
            }
            return allButtonsLength;
        }
